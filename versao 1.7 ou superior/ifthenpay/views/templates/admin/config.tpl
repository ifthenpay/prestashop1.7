	...
	<div class="row m-20">
		...
		<div class="col-sm-4 col-md-5 text-center">
			...
			<div class="col-sm-6">
				...
				<a href="https://helpdesk.ifthenpay.com/pt-PT/support/home" target="_blank" class="btn btn-default"
					id="">{l s='Go to Support!' mod='ifthenpay'}</a>
				<br />
				<br />
				<a href="https://github.com/ifthenpay/prestashop1.7/blob/main/versao%201.7%20ou%20superior/readme.pt.md" target="_blank" class="btn btn-default"
					id="">{l s='Go to User Manual!' mod='ifthenpay'}</a>
